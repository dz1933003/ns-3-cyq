...
#ifndef DPSK_NET_DEVICE_HELPER_H
#define DPSK_NET_DEVICE_HELPER_H
...
/**
 * \brief Build a set of DpskNetDevice objects
 *
 * Normally we eschew multiple inheritance, however, the classes
 * PcapUserHelperForDevice and AsciiTraceUserHelperForDevice are
 * "mixins".
 */
class DpskNetDeviceHelper : public PcapHelperForDevice, public AsciiTraceHelperForDevice
{
public:
  /**
   * Create a DpskNetDeviceHelper to make life easier when creating DPSK networks.
   */
  DpskNetDeviceHelper ();
  virtual ~DpskNetDeviceHelper ()
  {
  }

  /**
   * Each dpsk net device must have a queue to pass packets through.
   ...
   * DpskNetDevice created through DpskNetDeviceHelper::Install.
   */
   ...
   *
   * Set these attributes on each ns3::DpskNetDevice created
   * by DpskNetDeviceHelper::Install
   */
   ...
   * \param value the value of the attribute to set
   *
   * Set these attribute on each ns3::DpskChannel created
   * by DpskNetDeviceHelper::Install
   */
   ...
   *
   * This method creates a ns3::DpskChannel with the
   * attributes configured by DpskNetDeviceHelper::SetChannelAttribute,
   * then, for each node in the input container, we create a
   * ns3::DpskNetDevice with the requested attributes,
   * a queue for this ns3::NetDevice, and associate the resulting
   * ns3::NetDevice with the ns3::Node and ns3::DpskChannel.
   */
...
#endif /* DPSK_NET_DEVICE_HELPER_H */
